	...
	$(document).ready(function () {
        ...
        if (isDarkMode === null) {
            if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
                isDarkMode = 'true'; // Set to 'true' if system prefers dark mode
            } else {
                isDarkMode = 'false'; // Set to 'false' if system prefers light mode
            }
        }

        $('body').toggleClass('dark-theme', isDarkMode === 'true');
