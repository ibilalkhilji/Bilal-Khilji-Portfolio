...
<head>
    ...
    <title>Bilal Khilji | Full Stack Developer & Product Designer</title>

    <meta name="description"
          content="Portfolio of Bilal Khilji, a passionate full-stack developer and product designer. Explore my projects, skills, and experience.">

    <meta name="keywords"
          content="Bilal Khilji, Full Stack Developer, Product Designer, Web Developer, Portfolio, Laravel, PHP, JavaScript, React, Android Development, Freelance Developer, Web Applications, UI/UX Designer">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="author" content="Bilal Khilji">

    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/img/images/profile.jpg')}}">

    <meta property="og:type" content="website">
    <meta property="og:title" content="Bilal Khilji | Full Stack Developer & Product Designer">
    <meta property="og:description"
          content="Explore the portfolio of Bilal Khilji, a full-stack developer and product designer. View my projects, skills, and experience in web and mobile development.">
    <meta property="og:url" content="{{config('app.url')}}">
    <meta property="og:image" content="{{asset('assets/img/images/profile.jpg')}}">

    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Bilal Khilji | Full Stack Developer & Product Designer">
    <meta name="twitter:description"
          content="Discover the work of Bilal Khilji, a full-stack developer and product designer with extensive experience in building web and mobile applications.">
    <meta name="twitter:image" content="{{asset('assets/img/images/profile.jpg')}}">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "{{config('app.url')}}",
            "sameAs": [
                "https://www.linkedin.com/in/bilalkhilji",
                "https://github.com/bilalkhilji",
                "https://twitter.com/bilalkhilji"
            ],
            ...
            "image": "{{asset('assets/img/images/profile.jpg')}}",
            "description": "Full Stack Developer & Product Designer specializing in web and mobile development."
        }
    </script>
                ...
                <div class="menu-container">
                    <div class="logo">
                        <a class="navbar-brand me-0" href="{{ route('home') }}">
                            ...
                            <span>Bilal <span class="primary">Khilji</span></span>
                        </a>
                    </div>
                    <div class="navbar-main d-flex flex-grow-1">
                        ...
                        <ul class="navbar-info mx-auto">
                            <li class="nav-item">
                                <a @class(['nav-link','active'=>request()->routeIs('home')]) aria-current="page"
                                   href="{{ route('home') }}">
                            ...
                            <li class="nav-item">
                                <a @class(['nav-link','active'=>request()->routeIs('about')]) href="{{ route('about') }}">
                            ...
                            <li class="nav-item">
                                <a @class(['nav-link','active'=>request()->routeIs('works')]) href="{{ route('works') }}">
                            ...
                            <li class="nav-item">
                                <a @class(['nav-link','active'=>request()->routeIs('contact')]) href="{{ route('contact') }}">
                                    <svg class="nav-icon" viewBox="0 0 18 17" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
